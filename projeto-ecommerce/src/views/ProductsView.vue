<template>
  <div class="bg-[#f5f5f5] p-4 min-h-screen">
    ...
    <div class="flex justify-center gap-4 mt-6">
      <button @click="prevPage" :disabled="skip === 0"
        class="bg-[#f53d2d] text-white px-4 py-2 rounded hover:bg-[#e33625] disabled:bg-gray-400">Anterior</button>
      <button @click="nextPage"
        class="bg-[#f53d2d] text-white px-4 py-2 rounded hover:bg-[#e33625]">Próximo</button>
    </div>
  </div>
</template>
