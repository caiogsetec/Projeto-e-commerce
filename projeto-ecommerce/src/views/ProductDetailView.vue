<template>
  <div class="container mx-auto p-4 my-8">
    ...
    <div v-else-if="product" class="bg-white shadow-lg rounded-lg p-6">
      ...
      <button @click="handleAddToCart" class="bg-orange-500 text-black px-8 py-3 rounded-lg hover:bg-orange-600 text-xl font-semibold transition-colors duration-200">
    ...
    <div v-else class="text-center text-lg text-gray-600 p-8">
      ...
      <router-link to="/products" class="text-orange-600 hover:underline block mt-4">
